...
// frontend/src/componentes/Nomina/VacacionFormModal.vue
<template>
  <div v-if="mostrar" class="modal-overlay">
    <div class="modal-content">
      <h2 class="text-2xl font-bold mb-4">{{ modo === 'crear' ? 'Crear Nueva Solicitud de Vacación' : 'Editar Solicitud de Vacación' }}</h2>
...
watch(() => props.vacacionData, (newData) => {
...
const handleSubmit = () => {
  if (!formularioLocal.value.id_empleado || !formularioLocal.value.fecha_inicio || !formularioLocal.value.fecha_fin || !formularioLocal.value.estado) {
