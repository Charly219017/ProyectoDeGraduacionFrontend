      ...
      <div class="navbar-menu">
        ...
        <div class="nav-dropdown">
          ...
          <div class="dropdown-menu">
            <router-link to="/empleados" class="dropdown-item">Empleados</router-link>
        ...
        <div class="nav-dropdown">
          ...
          <div class="dropdown-menu">
            <router-link to="/mantenimiento/usuarios" class="dropdown-item">Usuarios</router-link>
        ...
        <div class="nav-dropdown">
          ...
          <div class="dropdown-menu">
            <router-link to="/reclutamiento/vacantes" class="dropdown-item">Vacantes</router-link>
            <router-link to="/reclutamiento/candidatos" class="dropdown-item">Candidatos</router-link>
            <router-link to="/reclutamiento/aplicaciones" class="dropdown-item">Aplicaciones</router-link>
            <router-link to="/reclutamiento/criterios" class="dropdown-item">Criterios</router-link>
            <router-link to="/reclutamiento/evaluaciones" class="dropdown-item">Evaluaciones</router-link>
            <router-link to="/reclutamiento/detalles_evaluacion" class="dropdown-item">Detalles de Evaluación</router-link>
          </div>
        </div>
