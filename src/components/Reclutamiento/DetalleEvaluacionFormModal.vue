    ...
    <div class="modal-content">
      ...
      <form @submit.prevent="handleSubmit">
        <div class="form-group">
          ...
          >
            <option v-for="evaluacion in evaluaciones" :key="evaluacion.id_evaluacion" :value="evaluacion.id_evaluacion">Evaluación #{{ evaluacion.id_evaluacion }}</option>
          </select>
        </div>
        <div class="form-group">
...
const handleSubmit = () => {
  if (!formularioLocal.value.id_evaluacion || !formularioLocal.value.id_criterio || !formularioLocal.value.puntuacion) {
