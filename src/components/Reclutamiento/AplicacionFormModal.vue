...
watch(() => props.aplicacionData, (newData) => {
  ...
  if (formularioLocal.value.fecha_aplicacion) {
    formularioLocal.value.fecha_aplicacion = formularioLocal.value.fecha_aplicacion.split('T')[0];
  }
}, { deep: true, immediate: true });

const handleSubmit = () => {
  if (!formularioLocal.value.id_vacante || !formularioLocal.value.id_candidato || !formularioLocal.value.fecha_aplicacion) {
