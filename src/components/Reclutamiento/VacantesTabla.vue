...
// frontend/src/componentes/Reclutamiento/VacantesTabla.vue
<template>
  <div class="vacantes-card">
    <h2 class="vacantes-title">Lista de Vacantes</h2>
    <div v-if="cargando" class="vacantes-empty">Cargando vacantes...</div>
    <div v-else-if="vacantes.length > 0" class="vacantes-table-container">
    ...
    <div v-else class="vacantes-empty">
